    ...
    return (
        <div className="flex flex-col gap-2 overflow-y-auto p-6">
            ...
            <AddToCart
                ...
                vintage={vintage}
            />
            {cart.length > 0 && <div className="flex gap-4 mt-xl  ">
...
const AddToCart = ({ projectDetails, handleAddToCart, quantityHandler, quantity, currentVinatgeQuantity, setCurrentVinatgeQuantity, setVintage, vintage }: any) => {
    return <div className="rounded-2xl bg-white shadow-md">
        <div className="border-b border-gray-200 px-4 py-4">
            <h2 className="text-f-3xl font-light text-gray-900">Choose your vintage</h2>
        </div>
            ...
            <div className="flex items-end gap-4">
                <div className="flex-1 space-y-2 ">
                    ...
                    <select
                        ...
                        className="w-full border border-gray-300 text-sm  px-4 py-2 rounded-md flex-1 text-black placeholder-gray-400  focus:outline-none focus:border-brand1-500 hover:border-brand1-500"
                    >
                ...
                <div className="flex-1 space-y-2">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2 text-black text-sm rounded-md border border-gray-300 placeholder-gray-400 focus:outline-none focus:border-brand1-500 hover:border-brand1-500"
                    />
