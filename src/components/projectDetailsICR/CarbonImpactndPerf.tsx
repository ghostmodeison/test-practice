        ...
        <div className="w-full bg-white mt-xl rounded-xl">
            ...
            <div className='p-xl text-black flex-col'>
                ...
                <div className='flex gap-xl mt-xl'>
                    <CarbonCard title="Estimated Annual Reductions" value={props.data.estimation_annual_estimated_reductions} />
                    <CarbonCard title="Actual Annual Reductions" value={props.data.actual_annual_estimated_reductions} />
                </div>
            </div>
